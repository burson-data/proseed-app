...
<html>
<head>
    <title>Upload Signed Receipt</title>
    <script src="https://cdn.tailwindcss.com"></script>
</head>
<body class="bg-gray-100 flex items-center justify-center h-screen">
    <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-md">
        <h1 class="text-2xl font-bold mb-4">Upload Signed Receipt</h1>
        ...
        <form action="{{ route('public.loan.upload.handle', $transaction->loan_upload_token) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
